...
export default function ArrayDisplay({ array, current }: ArrayDisplayProps) {
  return (
    <div className="mb-6 min-h-[120px] p-4 bg-white border-2 border-gray-200 rounded-lg flex flex-col justify-center items-center gap-2">
      {/* Pointers Row */}
        ...
        <div className="flex flex-wrap justify-center items-center gap-2 mb-2">
          {array.map((_, index) => {
            ...
            return (
              ...
              >
                {isLow && (
                  <div className="text-blue-600 font-semibold text-sm">low</div>
                )}
                {isHigh && (
